...
Revision ID: 9e8e44b24073
Revises: 2802eb62c668
Create Date: 2026-09-03 11:01:18.229659
"""
...
revision: str = '9e8e44b24073'
down_revision: Union[str, None] = '2802eb62c668'
...
def upgrade() -> None:
    ...
    op.add_column('knowledge_injection_job', sa.Column('created_at', sa.DateTime(), server_default=sa.text('now()'), nullable=False))
    # ### end Alembic commands ###


def downgrade() -> None:
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_column('knowledge_injection_job', 'created_at')
